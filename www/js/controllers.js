...
app.controller('mediaListController', function ($scope, $stateParams, userService, mediaListService, mediaService, modalService, activeUserService) {
...
app.controller('mediaController', function ($scope, $stateParams, $state, mediaService, modalService) {
